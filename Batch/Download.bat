...
set Speedo_Rest_Update_Url="https://www.dropbox.com/s/mzb59s2ypjung62/Speedoo%20APP%203.0.3.3%20FULL.exe?dl=0"
set Speedo_Rest_Update_File="Speedoo REST 3.0.3.3_FULL.exe"
@REM SQL Url
...
@REM SUPER POINT Url
set Super_Point_Url="https://mega.nz/file/NM8TCYCA#XPrO9Ja9dCscesdkmOdUByWSeGHO_fYL7Xjf8xpe3II"
set Super_Point_File="Point_Super3.0.0.2.exe"
@REM Point Charge Url
set Point_Charge_Url="https://mega.nz/file/3ERGEQIB#d00L_XIu34IY8SoYFSob3945CZdeAypa0SJvO0XrDyg"
set Point_Charge_File="Shipping_Plus_Server_With_Out_SQL2.2.0.0.exe"
@REM POS Url
set POS_Url="https://mega.nz/file/mVgGHSJL#urwynxhdNgbVH-Rhe109cE4yHmaUkom93E7MaUhayvw"
...
@REM Remotly Url
set Remotly_Url="https://www.dropbox.com/scl/fi/9ow4rsjibpre45oxx4vuk/remotly-new.rar?rlkey=39hr2zds8tirfc24z95cfbtbv&st=7l52dxt6&dl=0"
